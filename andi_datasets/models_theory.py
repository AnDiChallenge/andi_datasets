# AUTOGENERATED! DO NOT EDIT! File to edit: source_nbs/models_theory.ipynb (unless otherwise specified).

__all__ = ['models_theory', 'models_theory', 'models_theory', 'models_theory']
