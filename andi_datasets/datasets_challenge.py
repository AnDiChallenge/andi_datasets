# AUTOGENERATED! DO NOT EDIT! File to edit: ../source_nbs/datasets_challenge.ipynb.

# %% auto 0
__all__ = ['challenge_2020_dataset', 'challenge_2022_dataset']

# %% ../source_nbs/datasets_challenge.ipynb 2
import numpy as np
...
# %% ../source_nbs/datasets_challenge.ipynb 5
def challenge_2020_dataset(N: int = 1000, 
                           max_T: int = 1000,
                           min_T: int = 10,
...
# %% ../source_nbs/datasets_challenge.ipynb 7
class _df_andi2: 
...
# %% ../source_nbs/datasets_challenge.ipynb 8
...
# %% ../source_nbs/datasets_challenge.ipynb 10
